...
public class TestAraignee {
    ...
    public static void main(String[] args) {
        ...
        c.add(b11);
        b11.addActionListener(new TraitementB(b11,compt));
        ...
        c.add(b12);
        b12.addActionListener(new TraitementB(b12,compt));
        ...
        c.add(b13);
        b13.addActionListener(new TraitementB(b13,compt));
        ...
        c.add(b21);
        b21.addActionListener(new TraitementB(b21,compt));
        ...
        c.add(b22);
        b22.addActionListener(new TraitementB(b22,compt));
        ...
        c.add(b23);
        b23.addActionListener(new TraitementB(b23,compt));
        ...
        c.add(b31);
        b31.addActionListener(new TraitementB(b31,compt));
        ...
        c.add(b32);
        b32.addActionListener(new TraitementB(b32,compt));
        ...
        c.add(b33);
        b33.addActionListener(new TraitementB(b33,compt));
